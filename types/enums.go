...
const (
	...
	LoreEventTag_LOCK_FILE_ACQUIRE                   LoreEventTag = 120
	LoreEventTag_LOCK_FILE_ACQUIRE_IGNORE            LoreEventTag = 121
	...
	LoreEventTag_LOCK_FILE_RELEASE                   LoreEventTag = 126
	LoreEventTag_LOCK_FILE_RELEASE_NOT_FOUND         LoreEventTag = 127

...
def generate_templates(
    header_file, templates_dir, generate_targets, ast_visitor, build_augmented=None
):
    ...
    Args:
        ...
        build_augmented: optional callable(visitor) returning a dict of
            additional Jinja globals (registry-style precomputed values)
    """
    ...
    if build_augmented:
        jinja_env.globals.update(build_augmented(lore_visitor))
